    ...
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-display text-xl font-semibold tracking-tight text-white">Reminders</h1>
            <p className="text-sm text-slate-500">Scheduled messages and delivery history</p>
          </div>
        </div>
        <Button type="button" className="h-9 rounded-lg border-0 bg-blue-600 px-4 text-xs font-medium text-white shadow-md shadow-blue-600/25 hover:bg-blue-500">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4 md:gap-4">
        {[
          ...
          { label: "Queued", value: "12", icon: Clock, color: "text-amber-400", bg: "bg-amber-500/5", border: "border-amber-500/10" },
          { label: "Success rate", value: "98%", icon: CheckCircle2, color: "text-emerald-400", bg: "bg-emerald-500/5", border: "border-emerald-500/10" },
          { label: "Failed", value: "03", icon: XCircle, color: "text-rose-400", bg: "bg-rose-500/5", border: "border-rose-500/10" },
        ].map((stat) => (
          <div key={stat.label} className="app-panel group p-4 shadow-inner transition-colors hover:border-slate-700">
            <div className="flex items-center gap-3">
      ...
      <div className="app-panel overflow-hidden">
        <div className="hidden border-b border-slate-800 bg-slate-950/50 px-4 py-2.5 md:grid md:grid-cols-12 md:gap-4">
            ...
            return (
              <div key={r.id} className="grid grid-cols-12 gap-4 px-4 py-2.5 hover:bg-slate-800/30 transition-colors items-center group">
                ...
                <div className="hidden md:flex col-span-2 items-center">
                  <span className="rounded-md border border-slate-800 bg-slate-950 px-2 py-0.5 text-xs font-medium text-slate-400">
                    {r.channel}
                  </span>
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
        <div className="app-panel border-l-4 border-l-blue-500 p-5">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-white">Automation ideas</h3>
          </div>
          <div className="space-y-2">
            {[
              ...
              <div key={trigger.title} className="flex items-center justify-between rounded-lg border border-slate-800/60 bg-slate-950/40 p-2.5">
                <div>
                  <p className="text-sm font-medium text-slate-200">{trigger.title}</p>
        ...
        <div className="app-panel p-5">
          <h3 className="mb-4 text-sm font-semibold text-white">Sample WhatsApp text</h3>
          <div className="space-y-3">
             <div className="rounded-lg border border-slate-800/60 bg-slate-950/40 p-3">
               ...
               <div className="mt-3 flex items-center justify-between">
                 ...
                 <Button variant="ghost" size="sm" className="h-7 px-2 text-xs font-medium text-blue-400 hover:bg-blue-500/10">Edit</Button>
               </div>
             </div>
          </div>
        </div>
